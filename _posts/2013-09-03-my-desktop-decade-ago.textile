...
Yes, that time I just gratuated from "SJTU":http://www.sjtu.edu.cn/ and working at Shanghai TV Station as a *CGer*. Still a lot to learn: Maya, Shake, Mel develop etc. And I am the only one in our group working on a station running Linux desktop! That's a * Redhat 9 * with KDE.

Compare to the desktop environment now-a-days, it still look so elegent and effecient. My favorate linux distro. is *Debian* with *FVWM2* desktop.
